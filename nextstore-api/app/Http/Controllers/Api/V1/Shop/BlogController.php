...
class BlogController extends Controller
{
    ...
    public function show(Request $request, Post $post): JsonResponse
    {
         ...
         * شمارنده‌ی بازدید.
         *
         * increment() مستقیم روی دیتابیس اجرا می‌شود و updated_at را
         * دست نمی‌زند — وگرنه هر بازدید، مقاله را «تازه ویرایش‌شده»
         * نشان می‌داد و ترتیب‌های مبتنی بر updated_at خراب می‌شد.
         */
